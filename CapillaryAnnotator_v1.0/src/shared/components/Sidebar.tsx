...
import { MousePointer2, Ruler, Download, X, AlertCircle, Wand2, Sparkles, Loader2, RotateCw } from 'lucide-react';
        ...
        <div className="w-80 bg-gray-800 border-l border-gray-700 flex flex-col h-full text-white">
            ...
            <div className="p-4 border-b border-gray-700">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-gray-500">{rotation.toFixed(1)}°</span>
                </div>
