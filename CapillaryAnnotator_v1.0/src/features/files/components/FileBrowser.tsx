        ...
        <div className="w-48 bg-gray-800 border-r border-gray-700 flex flex-col h-full">
            <div className="p-2 border-b border-gray-700 flex-shrink-0">
                ...
                <button
                    ...
                    className="w-full text-xs bg-blue-600 hover:bg-blue-700 text-white py-1.5 px-2 rounded transition-colors"
            ...
            {subdirectories.length > 0 && (
                <div className="p-2 border-b border-gray-700 flex-shrink-0">
                    <label className="text-[10px] text-gray-400 mb-1 block">Image Set:</label>
                    <div className="relative">
                        <select
                            value={selectedSubdirectory}
                            onChange={(e) => handleSubdirectoryChange(e.target.value)}
                            className="w-full bg-gray-700 text-white text-xs py-1 px-2 pr-7 rounded border border-gray-600 appearance-none cursor-pointer hover:bg-gray-600 transition-colors"
                        >
                    ...
                    {files.map((fileEntry, index) => (
                        ...
                        >
                            ...
                            <div className="bg-gray-900 p-1">
                                <p className="text-[10px] text-gray-300 truncate" title={fileEntry.filename}>
                                    {fileEntry.filename}
                                </p>
                            </div>
                        </div>
