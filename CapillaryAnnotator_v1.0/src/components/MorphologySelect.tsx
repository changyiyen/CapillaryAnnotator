...
const MORPHOLOGY_OPTIONS: { value: Loop['morphology']; label: string; color: string }[] = [
    { value: 'Normal', label: 'Normal', color: '#3b82f6' },
    { value: 'Tortuous', label: 'Tortuous', color: '#10b981' }, // Green
    { value: 'Enlarged', label: 'Enlarged', color: '#8b5cf6' },
    { value: 'Giant', label: 'Giant', color: '#ec4899' },
    { value: 'Ramified', label: 'Ramified', color: '#f59e0b' },
    { value: 'Bizarre', label: 'Bizarre', color: '#ef4444' },
];
